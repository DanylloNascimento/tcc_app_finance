...
class AlphaVantageClient {
  ...
  Future<Response> get({String function="TIME_SERIES_INTRADAY", required String symbol, required String symbols
                       ,String interval="1min", required String outputsize, required String apiKey
                       ,required String fromCurrency, required String toCurrency
                       ,required String market, required String timePeriod, required String seriesType}) async {
  ...
  Map<String, String> _addQueryParams({String function="TIME_SERIES_INTRADAY", required String symbol, required String symbols
                                      , String interval="1min", required String outputsize, required String apiKey
                                      ,required String fromCurrency, required String toCurrency
                                      , required String market, required String timePeriod, required String seriesType}) {
